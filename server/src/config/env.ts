...
const schema = z.object({
  ...
  OCR_PREPROCESS_MAX_EDGE: z.coerce
    .number()
    .int()
    .min(800)
    .max(5000)
  ...
  MOBILE_APK_PATH: z.string().default("mobile-app/asel-pointage.apk"),
  MOBILE_APK_VERSION: z.string().default("0.1.1"),
  MOBILE_APP_API_BASE_URL: z.string().url().optional(),
...
export const env = {
  ...
  SEED_SHARED_PASSWORD:
    parsed.data.SEED_SHARED_PASSWORD ?? parsed.data.SEED_ADMIN_PASSWORD,
};
