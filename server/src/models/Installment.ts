...
const installmentRenegotiationHistorySchema = new Schema(
  {
    type: {
      type: String,
      enum: ["postpone", "split", "merge", "waive"],
      required: true,
    },
    reason: { type: String, trim: true, maxlength: 1000, default: "" },
    userId: { type: Schema.Types.ObjectId, ref: "User", required: true },
    ...
    relatedInstallmentIds: {
      type: [{ type: Schema.Types.ObjectId, ref: "Installment" }],
      default: [],
    },
...
const installmentSchema = new Schema(
  {
    ...
    status: {
      type: String,
      enum: ["pending", "paid", "late", "renegotiated"],
      default: "pending",
    },
    ...
    waivedAmount: { type: Number, min: 0, default: 0 },
    renegotiatedAt: { type: Date, default: null },
    renegotiatedBy: { type: Schema.Types.ObjectId, ref: "User", default: null },
    renegotiationHistory: {
      type: [installmentRenegotiationHistorySchema],
      default: [],
    },
    note: { type: String, trim: true, maxlength: 1000 },
    splitFromInstallmentId: {
      type: Schema.Types.ObjectId,
      ref: "Installment",
      default: null,
    },
